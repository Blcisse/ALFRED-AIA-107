...
export const ChatMessageView = ({ className, children, ...props }: ChatProps) => {
  ...
  return (
    <div
      ...
      className={cn('flex flex-col justify-end bg-gradient-to-b from-gray-100 to-gray-300 dark:from-gray-800 dark:to-gray-900 p-4 rounded-lg shadow-md', className)}
      {...props}
    >
      {children}
    </div>
