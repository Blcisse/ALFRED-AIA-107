...
export function AgentControlBar({
  ...
  return (
    <div
      ...
      className={cn(
        'bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 flex flex-col rounded-[31px] border p-3 drop-shadow-md/3',
        className
      )}
      {...props}
    >
      {capabilities.supportsChatInput && (
        ...
        >
          ...
          <hr className="bg-separator1 my-3" />
        </div>
      )}
